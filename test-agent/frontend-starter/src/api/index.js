...
export const seedAgents = async () => {
  const response = await api.get('/api/agents/seed');
  return response.data;
};
...
export const releaseIntervention = async (conversationId, supervisorNotes, agentRating) => {
  const response = await api.post('/api/intervene/release', { conversationId, supervisorNotes, agentRating });
  return response.data;
};
...
export const seedTemplates = async () => {
  const response = await api.get('/api/templates/seed');
  return response.data;
};
